...
class DiggingDeeperController extends Controller
{
    /**
     * Базовая информация:
     * @url https://laravel.com/docs/collection
     *
...
//            ->firstWhere('created_at', '>', '2019-01-17 01:35:11');
        ...
        //Базовая переменна не изменится. Просто вернется измененная версия.
...
//        dd($result);
        ...
        //Базовая переменнаяизменится (трансформируется).
...
//        dd(compact('filtered'));
    ...
    /**
     * @link http://project/digging_deeper/prepare-catalog
     *
